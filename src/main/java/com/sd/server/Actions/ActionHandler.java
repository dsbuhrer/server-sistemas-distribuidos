...
import com.sd.server.repositories.EmpresaRepository;
...
public class ActionHandler {
    ...
    private static final EmpresaRepository empresa_repository = new EmpresaRepository();
...
//        System.out.println("operacao");
        ...
        try {
            return switch (operacao) {
                ...
                case "loginEmpresa" -> login_repository.loginEmpresa(operacao, response_action,ip);
                ...
                case "cadastrarEmpresa" -> empresa_repository.create(operacao, response_action);
                case "listarCandidatos" -> user_repository.get(operacao, response_action);
                case "listarEmpresa" -> empresa_repository.get(operacao, response_action);
                case "apagarCandidato" -> user_repository.destroy(operacao, response_action);
                case "apagarEmpresa" -> empresa_repository.destroy(operacao, response_action);
                case "visualizarCandidato" -> user_repository.find(operacao, response_action);
                case "visualizarEmpresa" -> empresa_repository.find(operacao, response_action);
                case "atualizarCandidato" -> user_repository.update(operacao, response_action);
                case "atualizarEmpresa" -> empresa_repository.update(operacao, response_action);
